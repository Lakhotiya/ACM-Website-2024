        ...
        <>
            <div className="footer">
                ...
                <Link to="/Home" className="logo">
                    <img src="/acm_logo_white.png" alt="ACM Logo" style={{height: "10rem"}} />
                </Link>
